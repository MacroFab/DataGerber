#
# Data::Gerber::DrillParser
#
# Parse Drill Formatted Lines
#
# (c) 2014 MacroFab, Inc.
# Author: D. Calderon (Derived from Data::Gerber::Parser by C. Church)
#================================================

package Data::Gerber::DrillParser;
...
=head1 SYNOPSIS
	...
	my $gbParse = Data::Gerber::DrillParser->new();
...
=head1 DESCRIPTION
 ...
 Data::Gerber::DrillParser parses Excellon (Drill) data from a file, or from an array
...
=item new( OPTS )
 ...
 for example: 
 	...
 	my $gbParse = Data::Gerber::DrillParser->new( 'ignoreInvalid' => 1 );
